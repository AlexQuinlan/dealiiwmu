        ...
        case NormalProjection:
          {
            ...
            tria.set_manifold(2, normal_projector);
        ...
        case DirectionalProjection:
          {
            OpenCASCADE::DirectionalProjectionManifold<3, 3>
              directional_projector(bow_surface,
                                    Point<3>(0.0, 1.0, 0.0),
                                    tolerance);
            tria.set_manifold(2, directional_projector);
        ...
        case NormalToMeshProjection:
          {
            ...
            tria.set_manifold(2, normal_to_mesh_projector);
  ...
  try
    {
      ...
      const std::string in_mesh_filename = "input/initial_mesh_3d.inp";
