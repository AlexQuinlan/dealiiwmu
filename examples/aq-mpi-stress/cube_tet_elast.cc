...
//template <int dim>
//void tetElast<dim>::read_bcs()  // this seems to be redundant
//{
//	pcout << "Entered into read_bcs()" << std::endl;
...
void tetElast<dim>::setup_system()
{
  ...
  // Step 17 has locally_owned_dofs_per_proc and locally_owned_dofs  written here


  // in step-6, this line is 'sparsity_pattern.copy_from(dsp);;
  ...
  // //constraints.close();		   this is now done in nodal_bcs()
...
int main(int argc, char **argv)
{
  ...
  const std::string nodalbc_filename = "input/cube-bcs.csv";
  const std::string out_mesh_filename = ("output/cube_mesh.vtk");
