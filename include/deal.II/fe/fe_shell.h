...
#ifndef dealii_fe_shell_h
#define dealii_fe_shell_h
...
class FE_Shell : public FE_Shell_Base<dim, spacedim>
{
public:
  /**
   ...
   */
  FE_Shell(const Quadrature<1> &points);
