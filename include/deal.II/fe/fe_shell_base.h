...
#ifndef dealii_fe_shell_base_h
#define dealii_fe_shell_base_h
...
/**
 * This class is adapterd from fe_q_base.h
 * This class collects the basic methods used in FE_Shell
 * There is no public constructor for this class as it is not
 * functional as a stand-alone. The completion of definitions is left to the
 * derived classes.
 */
template <int dim, int spacedim = dim>
class FE_Shell_Base : public FE_Poly<dim, spacedim>
{
public:
  /**
   * Constructor.
   */
  FE_Shell_Base(const ScalarPolynomialsBase<dim> &poly_space,
  ...
  DeclExceptionMsg(ExcFEQCannotHaveDegree0,
                   "FE_Shell_Q can only be used for polynomial degrees "
...
protected:
  ...
  friend struct FE_Shell_Base<dim, spacedim>::Implementation;
